...
phys_mem_t setup_kernel_page_table()
{
  ...
  */
  ...
  /* Create a section entry to do a direct mapping for addresses
     C0500000 through C05FFFFF.  This is temporary, for project 8.
  */
  ...
  /* set outer and inner cache to write back, no write allocate */
  kernel_page_table[entry].section.TEX = 0; 
  /* set access permissions to not let user level processes
     access this section */
